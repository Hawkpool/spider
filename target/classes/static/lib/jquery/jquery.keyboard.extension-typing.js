...
//			if (base.options.lockInput) { base.typing_options.showTyping = false; }
                ...
                el
                    .bind('keyup.keyboard', function (e) {
                        ...
                        if (e.which === 16 || e.which === 18) {
                            ...
                            setTimeout(function () {
                                base.$preview.focus();
                            }, 200); // Alt key will shift focus to the menu - doesn't work in Windows
                            return;
                        }
                    })
            ...
            base.typing_simulateKey = function (el, txt) {
                var e = el.length;
                if (e) {
                    el.filter(':visible').trigger('mouseenter.keyboard');
                }
                base.typing_timer = setTimeout(function () {
                    if (e) {
                        setTimeout(function () {
                            el.trigger('mouseleave.keyboard');
